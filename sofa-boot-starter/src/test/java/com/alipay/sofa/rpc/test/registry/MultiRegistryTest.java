...
@SpringBootTest(properties = { "com.alipay.sofa.rpc.registries.gateway=zookeeper://127.0.0.1:2181" },
        classes = MultiRegistryTest.class)
@RunWith(SpringRunner.class)
@ImportResource("classpath*:spring/test_only_registry.xml")
