 ...
 */
package com.alipay.sofa.rpc.test.dubbo;
...
@SpringBootTest(properties = { "com.alipay.sofa.rpc.registry.address=zookeeper://localhost:2181" },
        classes = DubboInvokeTest.class)
@RunWith(SpringRunner.class)
@Import(DubboInvokeTest.Config.class)
public class DubboInvokeTest {
    ...
    @Test
    public void testDubboInvoke() throws InterruptedException {
