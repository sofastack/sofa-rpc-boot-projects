...
public class ServerConfigContainerTest {
    ...
    public void testGetServerConfig() {
        ...
        ServerConfig serverConfigBolt = ServerConfigContainer
            .createBoltServerConfig();
        ServerConfig serverConfigRest = ServerConfigContainer
            .createRestServerConfig();
        ServerConfig serverConfigDubbo = ServerConfigContainer
